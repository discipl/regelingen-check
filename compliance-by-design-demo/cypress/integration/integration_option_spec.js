...
describe("The demo", function () {
  it("Should be able walk through a scenario", function () {
    ...
    answerQuestion(
      "[aanvrager heeft voldaan aan enig wettelijk voorschrift voor het in behandeling nemen van de aanvraag]",
      "No"
    );
    answerQuestion(
      "[aanvrager heeft de gelegenheid gehad de aanvraag aan te vullen]",
      "Yes"
    );
    answerQuestion(
      "[de aanvraag is binnen de afgelopen 4 weken aangevuld]",
      "No"
    );
    answerQuestion(
      "[gestelde termijn voor aanvulling is ongebruikt verstreken]",
      "Yes"
    );
  });
});

...
describe("The demo", function () {
  it("Should be able walk through a scenario", function () {
    ...
    answerQuestion(
      "[ingevuld aanvraagformulier studiekosten op de website van de Dienst Uitvoering Onderwijs]",
      "Yes"
    );

    answerQuestion(
      "[indienen 1 april tot en met 30 juni, voorafgaand aan het studiejaar waarvoor subsidie wordt aangevraagd]",
      "Yes"
    );
    ...
    answerQuestion(
      "[leraar die voor minimaal twintig procent van zijn werktijd is belast met lesgebonden taken]",
      "Yes"
    );
    answerQuestion(
      "[leraar die pedagogisch-didactisch verantwoordelijk is voor het onderwijs]",
      "Yes"
    );
    ...
    answerQuestion(
      "[subsidie wordt verstrekt voor één studiejaar en voor één opleiding]",
      "Yes"
    );
    answerQuestion(
      "[leraar ontvangt van de minister een tegemoetkoming in de studiekosten voor het volgen van de opleiding]",
      "No"
    );
    answerQuestion(
      "[minister verdeelt het beschikbare bedrag per doelgroep over de aanvragen]",
      "Yes"
    );
